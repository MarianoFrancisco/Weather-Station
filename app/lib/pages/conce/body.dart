...
class ConceBody extends StatelessWidget {
  const ConceBody({super.key});
    ...
    return SingleChildScrollView(
      child: Column(
        children: <Widget>[
          ...
          const Center(
            child: Text(
              'Informacion de la estacion Concepcion Chiquirichapa', 
...
Padding(
  ...
  child: FutureBuilder<WeatherData>(
    future: WeatherService().fetchLastRecord('Conce'),
